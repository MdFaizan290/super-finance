...
function Navbar() {
    ...
    return (
        <div className='navContainer'>
            <Link to={"/"} className='tagLink'><h5 className='tag'><i class="fa-solid fa-wallet"></i> <i class="fa-solid fa-dollar-sign s"></i>uper Finance</h5></Link>
            ...
            <p className='para' style={goal} onClick={() => {
                navigate("/goals/list");
                setActive("goal")
            }}><i class="fa-solid fa-bullseye"></i>Goal</p>
            <p className='para' style={invest} onClick={() => {
                window.location.href="http://localhost:3000/";
                setActive("invest")
            }}><i class="fa-solid fa-money-bill-trend-up"></i>Investment</p>
        </div>
    );
}
